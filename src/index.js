 ...
 * @param {any} input Item or an array of items that will be emitted to the reactor
 *                    when any of them change. The item or items will be compared shallowly
 *                    to determine if a new emit should take place.
 */
